  ...
  return (
    <section className="py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto backdrop-blur-md bg-white/60 rounded-xl px-6 py-8 shadow-sm border border-white/80">
          ...
          <div className="flex flex-row justify-center gap-4 mb-4">
            <Link
              href="/signup"
              className="bg-[var(--primary)] text-white transition-all py-2 px-6 rounded-md font-medium text-base hover:bg-[var(--primary-dark)] duration-200 shadow-sm"
            >
              دروستکردنی هەژمار
            </Link>
            <Link
              href="/write-here"
              className="bg-white/80 backdrop-blur-sm text-[var(--primary)] border border-[var(--primary)]/30 hover:bg-[var(--primary)]/5 transition-all py-2 px-6 rounded-md font-medium text-base duration-200 shadow-sm"
            >
