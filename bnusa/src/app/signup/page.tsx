...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[var(--primary)]/10 via-white to-[var(--secondary)]/10 px-0 font-rabar">
