      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            dir="rtl"
          />
          <p className="mt-1 text-xs text-[var(--grey-dark)] text-right">بەتاڵی جێبهێڵە بۆ بەکارهێنانی بەشی یەکەمی ئیمەیل</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            dir="rtl"
          />
          <p className="mt-1 text-xs text-[var(--grey-dark)] text-right">وشەی نهێنی پێویستە لانیکەم ٦ پیت بێت</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-[var(--grey-light)] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary-light)] focus:border-transparent transition-all text-right"
            placeholder="وشەی نهێنی دووبارە بنووسەوە"
            disabled={loading}
            required
            dir="rtl"
          />
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-gray-500 text-right">دوای دروستکردنی هەژمار ڕاستەوخۆ دەبرێیت بۆ داشبۆرد</p>
        </div>
      </form>
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <button
            ...
            disabled={loading}
            className={`w-full flex justify-center items-center py-3 px-4 border border-[var(--grey-light)] rounded-lg shadow-sm bg-white text-sm font-medium text-[var(--grey-dark)] hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--primary-light)] transition-all ${
              loading ? 'opacity-70 cursor-not-allowed' : ''
            }`}
          >
