          ...
          {displayedBooks.map((book, index) => (
            ...
            >
              <Link href={`/bookstore/${book._id}`}>
                <div className="group relative bg-white/10 backdrop-blur-md rounded-xl overflow-hidden border border-gray-100 hover:border-[var(--primary)]/50 transition-colors duration-300 shadow-sm hover:shadow-md">
